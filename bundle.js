(() => {
  ...
  var getHash = (text) => (0, import_sha.default)("sha512").update(text).digest("hex");
  var getPassword = (password, service, length = 12, alphabet = DEFAULT_CHARACTER_SET) => {
  ...
  var getCssColor = (text, s = 75, l = 75) => {
